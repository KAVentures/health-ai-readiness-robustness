...
bounded and mitigated as described in §3.1, §3.4, and §5 (every rater's labels released
separately; the human-leniency conclusion shown to hold on the two independent clinicians' labels
alone; the author-influenced consensus reported only as a secondary reference). No other competing
interests.
...
This study used publicly released, de-identified benchmark data and machine-generated outputs. It
involved no patients, clinical intervention, biological material, or sensitive personal data. Two
independent clinicians and the author provided blinded annotations for a 50-item subset using
de-identified rater codes. The clinicians consented to the research use and public release of their
de-identified annotations.

The research principal assessed the project as falling outside the mandatory-review provisions of
the Swedish Ethical Review Act (2003:460); no application was submitted to the Swedish Ethical
Review Authority. The assessment is documented in `manuscript/ethics_self_assessment.md`.

The study evaluates model behaviour and evaluator calibration and does not establish clinical
deployment safety or patient benefit.
